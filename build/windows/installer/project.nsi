...
Section "Content Blueprint" SEC_MAIN
  ...
  File "..\..\..\facebook-extension\icon-16.png"
  File "..\..\..\facebook-extension\icon-32.png"
  File "..\..\..\facebook-extension\icon-48.png"
...
brave_64_registration_done:
  ...
  Delete /REBOOTOK "$INSTDIR\facebook-extension\icon-16.png"
  Delete /REBOOTOK "$INSTDIR\facebook-extension\icon-32.png"
  Delete /REBOOTOK "$INSTDIR\facebook-extension\icon-48.png"
